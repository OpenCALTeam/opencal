...
void sciddicaS3hexComputeExtremes(struct CALModel2D* ca2D, struct CALSubstate2Dr* Q, CALreal* m, CALreal* M)
{
	int i, j;
...
void display(void)
{
	...
	sciddicaS3hexComputeExtremes(s3hex, Q.h, &h_min, &h_Max);
...
int main(int argc, char** argv)
{
	...
	sciddicaS3hexCADef();
	sciddicaS3hexCALCLDef();
	sciddicaS3hexComputeExtremes(s3hex, Q.z, &z_min, &z_Max);
