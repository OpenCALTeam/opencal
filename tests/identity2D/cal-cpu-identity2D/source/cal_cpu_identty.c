...
//void life_transition_function(struct CALModel* life, int i, int j)
//{
...
//	 }
    ...
    a[1]=10;
    //cadef and rundef
    life = calCADef(2,a,CAL_MOORE_NEIGHBORHOOD, CAL_SPACE_TOROIDAL, SERIAL, CAL_NO_OPT);
