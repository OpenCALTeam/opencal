...
#define initThreads3D() if(get_global_id(0)>=get_rows() || get_global_id(1)>=get_columns()|| get_global_id(2)>=get_layers()) return
...
/*! \brief Gets the active cell layer coordinate relative to the given thread id */
