...
typedef enum CALCLOptimization {
	CALCL_NO_OPT = 0,				//!< Enumerator used for specifying no optimizations.
	CALCL_OPT_ACTIVE_CELLS			//!< Enumerator used for specifying the active cells optimization with stream compaction
}CALCLOptimization;
