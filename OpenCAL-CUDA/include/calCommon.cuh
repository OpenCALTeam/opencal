...
//#define calCudaGetToroidalX(index, size) (   (index)<0?((size)+(index)):( (index)>((size)-1)?((index)-(size)):(index) )   )
...
/*! The follow struct is used when you need single layer byte substates, and you're using CUDA version of the library.
*/
struct CudaCALSubstate2Db {
	CALbyte* substates;	//!< Linearised matrix of the byte substates.
};

/*! The follow struct is used when you need single layer integer substates, and you're using CUDA version of the library.
*/
struct CudaCALSubstate2Di {
	CALint* substates;	//!< Linearised matrix of the integer substates.
};

/*! The follow struct is used when you need single layer floating point substates, and you're using CUDA version of the library.
*/
struct CudaCALSubstate2Dr {
	CALreal* substates;	//!< Linearised matrix of the real (floating point) substates.
};
