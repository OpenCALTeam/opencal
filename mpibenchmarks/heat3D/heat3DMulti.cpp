...
#define KERNEL_SRC "/home/mpiuser/git/heat3D/kernel_heat3D/source/"
#define KERNEL_INC "/home/mpiuser/git/heat3D/kernel_heat3D/include/"
...
void heatModel_initMaterials (struct CALModel3D* host_CA, int i, int j, int k){
//		if(i > MATERIAL_START_ROW && i<MATERIAL_END_ROW)
//        calSet3Db(host_CA, Q_material, i, j, k, CAL_TRUE);
//    else
//        calSet2Db(host_CA, Q_material, i, j, CAL_FALSE);
    
}

void init(struct CALCLMultiGPU* multigpu, const Cluster3D* c)
{
