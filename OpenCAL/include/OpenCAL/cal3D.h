...
*/
typedef void (* CALCallbackFunc3D)(struct CALModel3D* ca3D, int i, int j, int z);
...
struct CALModel3D {
    ...
    struct CALContiguousLinkedList3D* contiguousLinkedList; //!< Computational Active cells object (optimal implementation). if A.actives==NULL no optimization is applied.
