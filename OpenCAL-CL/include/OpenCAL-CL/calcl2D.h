...
struct CALCLModel2D {
	...
	CALCLmem bufferMiximab;                 //!< Opencl kernel that contains max results for CALbyte substates GPU side
	CALCLmem bufferMiximai;                 //!< Opencl kernel that contains max results for CALint substates GPU side
	CALCLmem bufferMiximar;                 //!< Opencl kernel that contains max results for CALreal substates GPU side
