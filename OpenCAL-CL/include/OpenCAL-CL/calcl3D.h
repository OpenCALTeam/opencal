...
#define KER_MERGE_FLAGS "calclMergeFlags3D"
#define KER_SET_DIFF_FLAGS "calclsetDiffFlags3D"

#define MODEL_ARGS_NUM 60		//!< Number of default arguments for each kernel defined by the user
