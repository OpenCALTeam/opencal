...
__global CALbyte * calclGetSingleLayerSubstate2Db(__CALCL_MODEL_2D, CALint substateNum) {
    return (CALCLSingleLayerByteSubstates + calclGetRows() * calclGetColumns() * substateNum);
}
__global CALreal * calclGetSingleLayerSubstate2Dr(__CALCL_MODEL_2D, CALint substateNum) {
    return (CALCLSingleLayerRealSubstates + calclGetRows() * calclGetColumns() * substateNum);
}
__global CALint * calclGetSingleLayerSubstate2Di(__CALCL_MODEL_2D, CALint substateNum) {
    return (CALCLSingleLayerIntSubstates + calclGetRows() * calclGetColumns() * substateNum);
}
...
CALbyte calclGetSingleLayer2Db(__CALCL_MODEL_2D,CALint substateNum, int i, int j) {
    __global CALbyte * current = calclGetSingleLayerSubstate2Db(MODEL_2D,substateNum);
    return calclGetBufferElement2D(current, calclGetColumns(), i, j);
}
CALint calclGetSingleLayer2Di(__CALCL_MODEL_2D,CALint substateNum, int i, int j) {
    __global CALint * current = calclGetSingleLayerSubstate2Di(MODEL_2D,substateNum);
    return calclGetBufferElement2D(current, calclGetColumns(), i, j);
}
CALreal calclGetSingleLayer2Dr(__CALCL_MODEL_2D,CALint substateNum, int i, int j) {
    __global CALreal * current = calclGetSingleLayerSubstate2Dr(MODEL_2D,substateNum);
    return calclGetBufferElement2D(current, calclGetColumns(), i, j);
}
...
void calclSetSingleLayer2Dr(__CALCL_MODEL_2D,CALint substateNum, int i, int j, CALreal value) {
    __global CALreal * current = calclGetSingleLayerSubstate2Dr(MODEL_2D,substateNum);
    calclSetBufferElement2D(current, calclGetColumns(), i, j, value);
}
void calclSetSingleLayer2Di(__CALCL_MODEL_2D,CALint substateNum, int i, int j, CALint value) {
    __global CALint * current = calclGetSingleLayerSubstate2Di(MODEL_2D,substateNum);
    calclSetBufferElement2D(current, calclGetColumns(), i, j, value);
}
void calclSetSingleLayer2Db(__CALCL_MODEL_2D,CALint substateNum, int i, int j, CALbyte value) {
    __global CALbyte * current = calclGetSingleLayerSubstate2Db(MODEL_2D,substateNum);
    calclSetBufferElement2D(current, calclGetColumns(), i, j, value);
}
...
CALbyte calclGetSingleLayerX2Db(__CALCL_MODEL_2D,CALint substateNum, int i, int j, int n) {
    __global CALbyte * current = calclGetSingleLayerSubstate2Db(MODEL_2D,substateNum);
    if ((calclGetNeighborhoodId() == CAL_HEXAGONAL_NEIGHBORHOOD_2D && j % 2 == 1) || (calclGetNeighborhoodId() == CAL_HEXAGONAL_NEIGHBORHOOD_ALT_2D && i % 2 == 1))
        n += CAL_HEXAGONAL_SHIFT;
...
CALint calclGetSingleLayerX2Di(__CALCL_MODEL_2D,CALint substateNum, int i, int j, int n) {
    __global CALint * current = calclGetSingleLayerSubstate2Di(MODEL_2D,substateNum);
    if ((calclGetNeighborhoodId() == CAL_HEXAGONAL_NEIGHBORHOOD_2D && j % 2 == 1) || (calclGetNeighborhoodId() == CAL_HEXAGONAL_NEIGHBORHOOD_ALT_2D && i % 2 == 1))
        n += CAL_HEXAGONAL_SHIFT;
...
CALreal calclGetSingleLayerX2Dr(__CALCL_MODEL_2D,CALint substateNum, int i, int j, int n) {
    __global CALreal * current = calclGetSingleLayerSubstate2Dr(MODEL_2D,substateNum);
    if ((calclGetNeighborhoodId() == CAL_HEXAGONAL_NEIGHBORHOOD_2D && j % 2 == 1) || (calclGetNeighborhoodId() == CAL_HEXAGONAL_NEIGHBORHOOD_ALT_2D && i % 2 == 1))
        n += CAL_HEXAGONAL_SHIFT;
