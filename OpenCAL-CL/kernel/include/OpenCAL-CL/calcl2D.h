...
/*! \brief Gets a pointer to the single layer byte matrix of the substate corresponding to substateNum */
__global CALbyte * calclGetSingleLayerSubstate2Db(__CALCL_MODEL_2D,	//!< Defines model parameters
                                              CALint substateNum										//!< Indicates the number of the substate
                                              );

/*! \brief Gets a pointer to the single layer integer matrix of the substate corresponding to substateNum */
__global CALint * calclGetSingleLayerSubstate2Di(__CALCL_MODEL_2D,	//!< Defines model parameters
                                             CALint substateNum										//!< Indicates the number of the substate
                                             );

/*! \brief Gets a pointer to the single layer real (floating-point) matrix of the substate corresponding to substateNum */
__global CALreal * calclGetSingleLayerSubstate2Dr(__CALCL_MODEL_2D,	//!< Defines model parameters
                                              CALint substateNum										//!< Indicates the number of the substate
                                              );
...
/*! \brief Returns the cell (i, j) value of a single layer byte substate.*/
CALbyte calclGetSingleLayer2Db(__CALCL_MODEL_2D,	//!< Defines model parameters
                    CALint substateNum,				//!< Indicates the number of the substate
                    int i, 							//!< Row coordinate of the cell
                    int j							//!< Column coordinate of the cell
                    );

/*! \brief Returns the cell (i, j) value of a single layer integer substate.*/
CALint calclGetSingleLayer2Di(__CALCL_MODEL_2D,	//!< Defines model parameters
                   CALint substateNum,				//!< Indicates the number of the substate
                   int i, 							//!< Row coordinate of the cell
                   int j							//!< Column coordinate of the cell
                   );

/*! \brief Returns the cell (i, j) value of a single layer real substate.*/
CALreal calclGetSingleLayer2Dr(__CALCL_MODEL_2D,	//!< Defines model parameters
                    CALint substateNum,				//!< Indicates the number of the substate
                    int i, 							//!< Row coordinate of the cell
                    int j							//!< Column coordinate of the cell
                    );
...
/*! \brief Returns the n-th neighbor of the cell (i, j) value of a real substate.*/
...
/*! \brief Returns the n-th neighbor of the cell (i, j) value of a single layer byte substate.*/
CALbyte calclGetSingleLayerX2Db(__CALCL_MODEL_2D,	//!< Defines model parameters
                     CALint substateNum,				//!< Indicates the number of the substate
                     int i,							//!< Row coordinate of the central cell.
                     int j,							//!< Column coordinate of the central cell.
                     int n							//!< Index of the n-th neighbor.
...
/*! \brief Returns the n-th neighbor of the cell (i, j) value of a single layer integer substate.*/
CALint calclGetSingleLayerX2Di(__CALCL_MODEL_2D,	//!< Defines model parameters
                    CALint substateNum,				//!< Indicates the number of the substate
                    int i,							//!< Row coordinate of the central cell.
                    int j,							//!< Column coordinate of the central cell.
                    int n							//!< Index of the n-th neighbor.
...
/*! \brief Returns the n-th neighbor of the cell (i, j) value of a single layer real substate.*/
CALreal calclGetSingleLayerX2Dr(__CALCL_MODEL_2D,	//!< Defines model parameters
                     CALint substateNum,				//!< Indicates the number of the substate
                     int i,							//!< Row coordinate of the central cell.
                     int j,							//!< Column coordinate of the central cell.
                     int n							//!< Index of the n-th neighbor.
...
/*! \brief Sets the cell (i, j) value of a single layer real substate.  */
void calclSetSingleLayer2Dr(__CALCL_MODEL_2D,		//!< Defines model parameters
                 CALint substateNum,				//!< Indicates the number of the substate
                 int i,							//!< Row coordinate of the cell.
                 int j,							//!< Column coordinate of the cell.
                 CALreal value					//!< Value to which the cell is set
...
/*! \brief Sets the cell (i, j) value of a single layer integer substate.  */
void calclSetSingleLayer2Di(__CALCL_MODEL_2D,		//!< Defines model parameters
                 CALint substateNum,				//!< Indicates the number of the substate
                 int i,							//!< Row coordinate of the cell.
                 int j,							//!< Column coordinate of the cell.
                 CALint value					//!< Value to which the cell is set
...
/*! \brief Sets the cell (i, j) value of a single layer byte substate.  */
void calclSetSingleLayer2Db(__CALCL_MODEL_2D,		//!< Defines model parameters
                 CALint substateNum,				//!< Indicates the number of the substate
                 int i,							//!< Row coordinate of the cell.
                 int j,							//!< Column coordinate of the cell.
                 CALbyte value					//!< Value to which the cell is set
